...
step1_sys_prompt = """
You are a thoughtful and knowledgeable assistant tasked with analyzing the diversity in three lists of movies. For each movie, the title, genres, and plot are provided. Use your expertise in film and storytelling to assess the uniqueness and variety of the movies within and across the lists and order the lists from least to most diverse.
...
2. Genres as a Key Factor:
    - Highlight the range of genres in each list, focusing on whether they include both mainstream and niche genres.
    - If a list includes overlapping genres, consider whether the inclusion still feels diverse (e.g., combining fantasy adventure with fantasy horror).
...
4. Handling Similar Lists:
    - If the lists are somehow similar and it is hard to decide, provide a second possible ordering of the lists. This can happen when the lists have similar genres or themes, making it challenging to determine the diversity.

Deliver your analysis and the final ordering of the lists in the following JSON format:

{
  "comparison": str,                     # Compare the lists.
  "most_diverse_list_reasoning": str,    # Explanation of why this list is the most diverse.
  "least_diverse_list_reasoning": str,   # Explanation of why this list is the least diverse.
...
error_log_file = "invalid_responses_think_single_two_options.log"
valid_responses_file = "valid_responses_think_single_two_options.json"
...
with open("evaluation_summary_think_single_two_options.log", 'w') as summary_log:
