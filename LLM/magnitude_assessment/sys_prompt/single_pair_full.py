...
step1_sys_prompt = """
You are a thoughtful and knowledgeable assistant tasked with analyzing the diversity in two lists of movies. For each movie, the title, genres, and plot are provided. Use your expertise in film and storytelling to assess the uniqueness and variety of the movies within and across the lists.
...
error_log_file = "pairwise_invalid_responses_pairwise_filtered_more_div_think_single.log"
valid_responses_file = "pairwise_valid_responses_pairwise_more_div_think_single.json"
...
with open("pairwise_more_div_think_single.log", 'w') as summary_log:
