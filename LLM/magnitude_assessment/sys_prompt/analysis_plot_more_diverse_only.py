...
step1_sys_prompt = """
You are a helpful assistant. Your goal is to analyze the diversity in three lists of movies. For each movie, the title and plot are provided.

Focus on Plot and Themes:
    - Analyze the plots to find nuanced differences in storytelling approaches.
    - Evaluate the overarching plot themes and how they contribute to the distinctiveness of each list.
...
error_log_file = "invalid_responses_filtered_more_div_plot.log"
valid_responses_file = "valid_responses_more_div_plot.json"
...
with open("evaluation_summary_more_div_plot.log", 'w') as summary_log:
