...
step1_sys_prompt = """
You are a thoughtful and knowledgeable assistant tasked with analyzing the diversity in three lists of movies. For each movie, the title is provided. Use your expertise in film and storytelling to assess the uniqueness and variety of the movies within and across the lists and order the lists from least to most diverse.
...
4. Handling Similar Lists:
    - If the lists are somehow similar and it is hard to decide, provide a second possible ordering of the lists. This can happen when the two lists have similar genres or themes, making it challenging to determine the diversity.
...
error_log_file = "invalid_responses_think_single_two_options_titles.log"
valid_responses_file = "valid_responses_think_single_two_options_titles.json"
...
with open("evaluation_summary_think_single_two_options_titles.log", 'w') as summary_log:
