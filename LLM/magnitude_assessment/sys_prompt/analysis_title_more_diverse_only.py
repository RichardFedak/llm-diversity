...
step1_sys_prompt = """
You are a helpful assistant. Your goal is to analyze the diversity in three lists of movies. For each movie, the title is provided.

Use your own knowledge of the movies to analyze them based on their titles only.
...

{
  ...
  "comparison": str        # Compare the lists based on their variety and movie themes.
}
"""
...
error_log_file = "invalid_responses_filtered_more_div_titles.log"
valid_responses_file = "valid_responses_more_div_titles.json"
...
with open("evaluation_summary_more_div_titles.log", 'w') as summary_log:
