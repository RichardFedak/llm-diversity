...
step1_sys_prompt = """
You are a thoughtful and knowledgeable assistant tasked with analyzing the diversity in three lists of movies. For each movie, the title, genres, and plot are provided. Use your expertise in film and storytelling to assess the uniqueness and variety of the movies within and across the lists.
...
error_log_file = "invalid_responses_filtered_more_div_think_single.log"
valid_responses_file = "valid_responses_more_div_think_single.json"
...
with open("evaluation_summary_more_div_think_single.log", 'w') as summary_log:
