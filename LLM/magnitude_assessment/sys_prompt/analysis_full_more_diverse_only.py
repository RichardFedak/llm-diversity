...
2. Focus on Plot and Themes:
   - If genres overlap significantly between the lists or number of unique genres for every list is the same:
...
error_log_file = "invalid_responses_filtered_more_div.log"
valid_responses_file = "valid_responses_more_div.json"
...
with open("evaluation_summary_more_div.log", 'w') as summary_log:
