...
step1_sys_prompt = """
You are a helpful assistant. Your goal is to analyze the diversity in three lists of movies. For each movie, the title and genres are provided.

Focus on Genres:
   - Assess the variety of genres in each list.
   - Identify unique genres in each list.
...
error_log_file = "invalid_responses_filtered_more_div_genres.log"
valid_responses_file = "valid_responses_more_div_genres.json"
...
with open("evaluation_summary_more_div_genres.log", 'w') as summary_log:
