...
{
    "list_A_groups": list,                 # Create groups of the movies from the list A. Each group should have a group number (incremental integer starting from 1), description of the group (e.g., "action movies", "Marvel movies"), and the list of movie titles that belong to the group.
    "list_B_groups": list,                 # Same grouping instructions as for list A.
    "list_C_groups": list,                 # Same grouping instructions as for list A.
    "comparison": object,                  # Compare the lists based on the groups you created. Generally, the more groups, the more diverse the list.
...
EVALUATION_NAME = "single_think_plot_analysis_groups"
