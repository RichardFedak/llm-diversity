...
class MovieEvaluator:
    ...
    def evaluate_data(self, data, gold_standard_field='selected'):
        ...
        if existing_results:
            ...
            evaluation_duration = existing_results["evaluation_duration"]
        ...
        for idx, item in enumerate(data):
            ...
            try:
                ...
                if all(key in output for key in [
                    ...
                    valid_outputs += 1
                    final_ordering = sorted(output["diversity_scores"], key=output["diversity_scores"].get)
                    fixed_order = ["A", "B", "C"]
        ...
        if existing_results:
            elapsed_time += evaluation_duration
