...
model_ids = [
    "tunedModels/magnitudetrainsplit1-rd6laxjbb7g",
    "tunedModels/magnitudetrainsplit2-zrtm8umgxj0p",
    "tunedModels/magnitudetrainsplit3-88jitlhr4xyr",
    "tunedModels/magnitudetrainsplit4-tqtxfjwt3t7o",
    "tunedModels/magnitudetrainsplit5-nmta5wpe4hn8",
]
        ...
        with open(test_file, 'r', encoding='utf-8') as f:
            ...
            for idx, row in enumerate(reader, start=1):
                ...
                try:
                    ...
                    if len(generated_output) == 5: # output should be like: A,B,C
                        valid_outputs += 1
