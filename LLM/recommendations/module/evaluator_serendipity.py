...
class MovieEvaluator:
    ...
    def evaluate_data(self, data):
        ...
        json_log_file = f"./serendipity_results/{self.evaluation_name}.json"
        ...
        for idx, item in enumerate(data):
            ...
            for i in range(len(item["iterations"])):
                ...
                eval_index = idx + i
                if existing_results and existing_results[eval_index]["serendipity_score"] != "X":
                    updated_results.append(existing_results[eval_index])
                    valid_outputs += 1
                    if existing_results[eval_index]["serendipity_score"] == existing_results[eval_index]["gold"]:
                        correct_outputs += 1
                    continue
                ...
                gold_serendipity_score = iter["serendipity_score"]
                prompt = ""
