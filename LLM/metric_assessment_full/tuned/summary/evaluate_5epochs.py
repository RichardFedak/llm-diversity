...
model_ids = [
    "tunedModels/metricreasoningsplit1-bns8n4b9usd7",
    "tunedModels/metricreasoningsplit2-h1zdtyi7ybu1",
    "tunedModels/metricreasoningsplit3-2psb5g0lq30j",
    "tunedModels/metricreasoningsplit4-212obava11hr",
    "tunedModels/metricreasoningsplit5-d0nu6lteegu6",
]
        ...
        with open(test_file, 'r', encoding='utf-8') as f:
            ...
            for idx, row in enumerate(reader, start=1):
                ...
                try:
                    ...
                    if all(key in generated_output for key in ["reasoning", "most_diverse_list"]):

                        gold_most_diverse_list = gold["most_diverse_list"]
                        generated_most_diverse_list = generated_output["most_diverse_list"]

                        valid_outputs += 1
                        if gold_most_diverse_list == generated_most_diverse_list:
                            print("ok")
                            correct_outputs += 1
                        else:
                            incorrect_outputs += 1
