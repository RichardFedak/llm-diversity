...
sys_prompt = """
You are an assistant tasked with comparing three lists of movies. For each movie, the title and cover is provided. 
Use your expertise to determine key differences between the lists and identify the most diverse list.
