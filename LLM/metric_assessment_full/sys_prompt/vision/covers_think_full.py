...
sys_prompt = """
You are an assistant tasked with comparing three lists of movies. For each movie, the title, genres, plot and cover is provided. 
Use your own judgment to determine what information is relevant when assessing the diversity of the lists. You may consider the movie titles, genres, plots and covers.
...
EVALUATION_NAME = "covers_think_full"
