...
sys_prompt = """
You are an assistant tasked with comparing three lists of movies. For each movie, the title, plot and its genres are provided. 
Focus on identifying any standout movies in each list that might significantly differ from the others, as these can affect the perception of diversity. 
Consider how the presence of such unique movies can influence the overall diversity of the list.
...
EVALUATION_NAME = "single_popularity_plot"
