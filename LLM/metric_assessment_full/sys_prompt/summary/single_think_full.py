...
sys_prompt = """
You are an assistant tasked with comparing three lists of movies and assessing their diversity. For each list, movie titles are provided along with their respective genres and plot descriptions, as well as an overall summary of the entire list.
...
Use your own judgment to determine what information is relevant when assessing the diversity of the lists. You may consider the movie titles, genres and plots provided or any information from the summary.
...
EVALUATION_NAME = "single_think_plot"
