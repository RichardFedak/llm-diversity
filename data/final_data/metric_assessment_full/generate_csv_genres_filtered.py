...
output_file = 'movie_diversity_genres_filtered.csv'
...
with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
    ...
    for item in data:
        ...
        input_text = (
            "Consider the following three lists of movies 'A', 'B' and 'C'. Evaluate which list of movies is more diverse based on the genres provided for each list.\n\n"
            f"List A:\n{list_A_info}\n\n"
            f"List B:\n{list_B_info}\n\n"
            f"List C:\n{list_C_info}\n\n"
            ...
            "Do not provide any explanation, justification, or additional output. Strictly respond with the single letter: 'A', 'B' or 'C'."
        )
