...
output_file = 'movie_diversity_pairs_movie_genres.csv'
...
with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
    ...
    for item in data:
        ...
        list_A_info = "\n".join([f"- {movie['title']} - Genres of the movie: {movie['genres']}" for movie in list_A])
        list_B_info = "\n".join([f"- {movie['title']} - Genres of the movie: {movie['genres']}" for movie in list_B])
        input_text = (
